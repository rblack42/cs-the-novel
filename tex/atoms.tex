...
\begin{figure}[ht]
\includegraphics[width=5cm]{atomic-structure.png}
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=5cm]{IBMlogo.jpg}
\end{figure}
...
The particles flying around the center are \bf{electrons}\index{Electrons}. These particles are
...
``Protons``, are about $10^{-13}$ meters in size. That is
...
for Sodium id $Na$ and the term for the Sodium ion is $Na^{+}$. This
